...
PRINT TAB(0,22);CHR$131;"On a lower row, is the normal-height";
PRINT TAB(0,23);CHR$131;"label at the left shown or blanked?";
PRINT TAB(0,24);CHR$135;"Any key: menu";
*FX15,1
K=GET
CHAIN "MENU"
END
