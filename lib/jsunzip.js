...
// some issues with decoding >8 bit offsets by
// Matt Godbolt <matt@godbolt.org>
// TODO: some files still fail to decode, e.g. tape repton infinity
...
define([], function () {
    ...
    function TINF() {
        ...
        this.read_bits = function (d, num, base, cock) {
            if (!num)
                return base;
