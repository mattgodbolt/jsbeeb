...
- `audioLatencyMs` - target audio buffer depth in milliseconds (default 40); raise it if sound clicks on a machine that drops frames, lower it to trade clicks for latency.
