...
- `palPersistence` / `rgbPersistence` - how much of the previous frame shows through each new one on the PAL TV
  and RGB monitor displays, from 0 (none) to 0.98 (a slow fade); the slider in the configuration dialog sets the
  showing display's amount live and remembers it.
